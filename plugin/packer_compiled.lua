...
_G.packer_plugins = {
  ...
  ["aerial.nvim"] = {
    ...
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/aerial.nvim",
  ...
  ["search-replace.nvim"] = {
    config = { "\27LJ\2\n—\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2*default_replace_single_buffer_options\bgcI)default_replace_multi_buffer_options\tegcI\nsetup\19search-replace\frequire\0" },
    loaded = true,
